...
11. 采集：树林/河边/花圃有伐木、钓鱼、采蜜的自雇活（见【可做的事】），随时能干，
   产物能卖商店换钱，也能自己用；持有专长工具（斧头/渔竿/镰刀）时工资更高。
...
- 除了固定工作，还有自雇活：村北树林伐木、河边钓鱼、花圃采蜜，随时能赚（产物可卖商店）。
- 感到饥饿（饱食度低）时去商店用 buy_item 买食物（如面包）；食物要用 use_item 食用才会提高饱食度。
- 干活收获的材料（小麦、木材、鲜鱼、蜂蜜等）可以到商店 sell_item 卖钱；商店只收标了收购价的商品。
- 种地收益：买种子种下后不用守着，成熟了回来 harvest 卖钱；持有肥料（yield_bonus）能多收，持有工具（工资+%）能多赚。
- 有闲钱可以考虑 buy_stock 投资小镇公司：股价随经营上涨，每天按业绩分红；【股票行情】里会显示你的持仓成本价，股价明显高于成本（浮盈可观）时用 sell_stock 止盈卖出，急需用钱时也先卖股票，别把钱全压在股票里。
